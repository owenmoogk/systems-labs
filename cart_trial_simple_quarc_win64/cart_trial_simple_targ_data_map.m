    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(23)  = dumData; %prealloc
                    ...
                    ;% cart_trial_simple_P.SignalGenerator_Frequency
                    section.data(21).logicalSrcIdx = 23;
                    section.data(21).dtTransOffset = 20;

                    ;% cart_trial_simple_P.Kp_Gain
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(8)  = dumData; %prealloc
                    ...
                    ;% cart_trial_simple_B.SignalGenerator
                    section.data(4).logicalSrcIdx = 3;
                    section.data(4).dtTransOffset = 3;

                    ;% cart_trial_simple_B.Sum
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(10)  = dumData; %prealloc
                    ...
                    ;% cart_trial_simple_DW.ToWorkspace1_PWORK.LoggedData
                    section.data(4).logicalSrcIdx = 14;
                    section.data(4).dtTransOffset = 3;

                    ;% cart_trial_simple_DW.E_PWORK.LoggedData
                    section.data(5).logicalSrcIdx = 15;
                    section.data(5).dtTransOffset = 4;

                    ;% cart_trial_simple_DW.ToWorkspace_PWORK.LoggedData
                    section.data(6).logicalSrcIdx = 16;
                    section.data(6).dtTransOffset = 5;

                    ;% cart_trial_simple_DW.ToWorkspace2_PWORK.LoggedData
                    section.data(7).logicalSrcIdx = 17;
                    section.data(7).dtTransOffset = 6;

                    ;% cart_trial_simple_DW.U_PWORK.LoggedData
                    section.data(8).logicalSrcIdx = 18;
                    section.data(8).dtTransOffset = 7;

                    ;% cart_trial_simple_DW.input_PWORK.LoggedData
                    section.data(9).logicalSrcIdx = 19;
                    section.data(9).dtTransOffset = 8;

                    ;% cart_trial_simple_DW.x_PWORK.LoggedData
    ...
    targMap.checksum0 = 4104408065;
    targMap.checksum1 = 153304690;
    targMap.checksum2 = 530702577;
    targMap.checksum3 = 3959443123;
