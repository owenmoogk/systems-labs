...
void cart_trial_simple_output(void)
{
   ...
   *  Clock: '<Root>/Clock'
   */
  SignalGenerator_tmp = cart_trial_simple_M->Timing.t[0];

  /* SignalGenerator: '<Root>/Signal Generator' */
  cart_trial_simple_B.SignalGenerator = sin(6.2831853071795862 *
    SignalGenerator_tmp * cart_trial_simple_P.SignalGenerator_Frequency) *
    cart_trial_simple_P.SignalGenerator_Amplitude;

  /* Sum: '<Root>/Sum' */
  cart_trial_simple_B.Sum = cart_trial_simple_B.SignalGenerator -
    cart_trial_simple_B.InverseModulus;

  /* Gain: '<Root>/Kp' */
  cart_trial_simple_B.Kp = cart_trial_simple_P.Kp_Gain * cart_trial_simple_B.Sum;

  /* Gain: '<S1>/Cable Gain' */
  cart_trial_simple_B.CableGain = cart_trial_simple_P.CableGain_Gain *
    cart_trial_simple_B.Kp;
  ...
  /* Clock: '<Root>/Clock' */
  cart_trial_simple_B.Clock = SignalGenerator_tmp;
}
...
RT_MODEL_cart_trial_simple_T *cart_trial_simple(void)
{
  ...
  /* External mode info */
  cart_trial_simple_M->Sizes.checksums[0] = (4104408065U);
  cart_trial_simple_M->Sizes.checksums[1] = (153304690U);
  cart_trial_simple_M->Sizes.checksums[2] = (530702577U);
  cart_trial_simple_M->Sizes.checksums[3] = (3959443123U);
  ...
  cart_trial_simple_M->Sizes.numBlocks = (20);/* Number of blocks */
  cart_trial_simple_M->Sizes.numBlockIO = (8);/* Number of block outputs */
  cart_trial_simple_M->Sizes.numBlockPrms = (75);/* Sum of parameter "widths" */
