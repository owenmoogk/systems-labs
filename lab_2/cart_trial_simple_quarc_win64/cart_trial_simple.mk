###########################################################################
## Makefile generated for component 'cart_trial_simple'. 
## 
## Makefile     : cart_trial_simple.mk
## Generated on : Fri Oct 31 10:15:16 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\cart_trial_simple.rt-win64
...
PRODUCT_NAME              = cart_trial_simple
MAKEFILE                  = cart_trial_simple.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2021b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2021b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\MTE360\Desktop\systems-lab\systems-labs-main
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = cart_trial_simple_comp.rsp
CMD_FILE                  = cart_trial_simple.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\cart_trial_simple.rt-win64
...
DEFINES_STANDARD = -DMODEL=cart_trial_simple -DNUMST=2 -DNCSTATES=1 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\cart_trial_simple_quarc_win64\cart_trial_simple.c $(START_DIR)\cart_trial_simple_quarc_win64\cart_trial_simple_data.c $(START_DIR)\cart_trial_simple_quarc_win64\cart_trial_simple_main.c $(START_DIR)\cart_trial_simple_quarc_win64\rtGetInf.c $(START_DIR)\cart_trial_simple_quarc_win64\rtGetNaN.c $(START_DIR)\cart_trial_simple_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = cart_trial_simple.obj cart_trial_simple_data.obj cart_trial_simple_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\cart_trial_simple_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\cart_trial_simple_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
cart_trial_simple.obj : $(START_DIR)\cart_trial_simple_quarc_win64\cart_trial_simple.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\cart_trial_simple_quarc_win64\cart_trial_simple.c


cart_trial_simple_data.obj : $(START_DIR)\cart_trial_simple_quarc_win64\cart_trial_simple_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\cart_trial_simple_quarc_win64\cart_trial_simple_data.c


cart_trial_simple_main.obj : $(START_DIR)\cart_trial_simple_quarc_win64\cart_trial_simple_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\cart_trial_simple_quarc_win64\cart_trial_simple_main.c


rtGetInf.obj : $(START_DIR)\cart_trial_simple_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\cart_trial_simple_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\cart_trial_simple_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\cart_trial_simple_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\cart_trial_simple_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\cart_trial_simple_quarc_win64\rt_nonfinite.c
