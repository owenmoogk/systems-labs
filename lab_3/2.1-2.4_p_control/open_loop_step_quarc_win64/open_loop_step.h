 ...
 * C source code generated on : Mon Nov 10 10:34:57 2025
 *
...
#ifndef RTW_HEADER_open_loop_step_h_
#define RTW_HEADER_open_loop_step_h_
#include <math.h>
#include <string.h>
#ifndef open_loop_step_COMMON_INCLUDES_
#define open_loop_step_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* open_loop_step_COMMON_INCLUDES_ */

#include "open_loop_step_types.h"
...
#define open_loop_step_rtModel         RT_MODEL_open_loop_step_T

/* Block signals (default storage) */
typedef struct {
  real_T mmcn;                         /* '<S3>/mm//cn' */
  real_T mmcn2;                        /* '<S3>/mm//cn - 2' */
  real_T SignalGenerator1;             /* '<Root>/Signal Generator1' */
  real_T CableGain;                    /* '<S3>/Cable Gain' */
  real_T TSamp;                        /* '<S1>/TSamp' */
  real_T Diff;                         /* '<S1>/Diff' */
  real_T DiscreteTransferFcn;          /* '<Root>/Discrete Transfer Fcn' */
  real_T TSamp_d;                      /* '<S2>/TSamp' */
...
typedef struct {
  ...
  real_T InverseModulus_PreviousInput; /* '<S3>/Inverse Modulus' */
  real_T InverseModulus_Revolutions;   /* '<S3>/Inverse Modulus' */
  real_T InverseModulus1_PreviousInput;/* '<S3>/Inverse Modulus1' */
  real_T InverseModulus1_Revolutions;  /* '<S3>/Inverse Modulus1' */
  ...
  boolean_T InverseModulus_FirstSample;/* '<S3>/Inverse Modulus' */
  boolean_T InverseModulus1_FirstSample;/* '<S3>/Inverse Modulus1' */
} DW_open_loop_step_T;

/* Backward compatible GRT Identifiers */
#define rtB                            open_loop_step_B
#define BlockIO                        B_open_loop_step_T
#define rtP                            open_loop_step_P
#define Parameters                     P_open_loop_step_T
#define rtDWork                        open_loop_step_DW
#define D_Work                         DW_open_loop_step_T

/* Parameters (default storage) */
struct P_open_loop_step_T_ {
  ...
  real_T SignalGenerator1_Amplitude;   /* Expression: 1
                                        ...
                                        */
  real_T SignalGenerator1_Frequency;   /* Expression: 0.5
                                        * Referenced by: '<Root>/Signal Generator1'
                                        */
  ...
  real_T TSamp_WtEt;                   /* Computed Parameter: TSamp_WtEt
                                        ...
                                        */
  real_T DiscreteTransferFcn_NumCoef;  /* Expression: [.2222]
                                        * Referenced by: '<Root>/Discrete Transfer Fcn'
                                        */
  real_T DiscreteTransferFcn_DenCoef[2];/* Expression: [1 -0.7778]
                                         * Referenced by: '<Root>/Discrete Transfer Fcn'
                                         */
  ...
  real_T TSamp_WtEt_h;                 /* Computed Parameter: TSamp_WtEt_h
                                        ...
                                        */
  real_T DiscreteTransferFcn1_NumCoef; /* Expression: [.2222]
                                        * Referenced by: '<Root>/Discrete Transfer Fcn1'
                                        */
  real_T DiscreteTransferFcn1_DenCoef[2];/* Expression: [1 -0.7778]
                                          * Referenced by: '<Root>/Discrete Transfer Fcn1'
                                          */
...
struct tag_RTM_open_loop_step_T {
  const char_T *path;
...
extern P_open_loop_step_T open_loop_step_P;

/* Block signals (default storage) */
extern B_open_loop_step_T open_loop_step_B;

/* Block states (default storage) */
extern DW_open_loop_step_T open_loop_step_DW;

/* Model entry point functions */
extern void open_loop_step_initialize(void);
extern void open_loop_step_output(void);
extern void open_loop_step_update(void);
extern void open_loop_step_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern open_loop_step_rtModel *open_loop_step(void);
...
extern RT_MODEL_open_loop_step_T *const open_loop_step_M;
 ...
 *
 * '<Root>' : 'open_loop_step'
 * '<S1>'   : 'open_loop_step/Discrete Derivative'
 * '<S2>'   : 'open_loop_step/Discrete Derivative1'
 * '<S3>'   : 'open_loop_step/Plant'
 */
#endif                                 /* RTW_HEADER_open_loop_step_h_ */
