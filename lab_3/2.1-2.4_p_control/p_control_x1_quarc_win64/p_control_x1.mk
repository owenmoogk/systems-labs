###########################################################################
## Makefile generated for component 'p_control_x1'. 
## 
## Makefile     : p_control_x1.mk
## Generated on : Fri Nov 14 09:56:40 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\p_control_x1.rt-win64
...
COMPILER_COMMAND_FILE     = p_control_x1_comp.rsp
CMD_FILE                  = p_control_x1.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\p_control_x1.rt-win64
...
DEFINES_STANDARD = -DMODEL=p_control_x1 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\p_control_x1_quarc_win64\p_control_x1.c $(START_DIR)\p_control_x1_quarc_win64\p_control_x1_data.c $(START_DIR)\p_control_x1_quarc_win64\p_control_x1_main.c $(START_DIR)\p_control_x1_quarc_win64\rtGetInf.c $(START_DIR)\p_control_x1_quarc_win64\rtGetNaN.c $(START_DIR)\p_control_x1_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = p_control_x1.obj p_control_x1_data.obj p_control_x1_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\p_control_x1_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\p_control_x1_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
p_control_x1.obj : $(START_DIR)\p_control_x1_quarc_win64\p_control_x1.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p_control_x1_quarc_win64\p_control_x1.c


p_control_x1_data.obj : $(START_DIR)\p_control_x1_quarc_win64\p_control_x1_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p_control_x1_quarc_win64\p_control_x1_data.c


p_control_x1_main.obj : $(START_DIR)\p_control_x1_quarc_win64\p_control_x1_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p_control_x1_quarc_win64\p_control_x1_main.c


rtGetInf.obj : $(START_DIR)\p_control_x1_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p_control_x1_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\p_control_x1_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p_control_x1_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\p_control_x1_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p_control_x1_quarc_win64\rt_nonfinite.c
