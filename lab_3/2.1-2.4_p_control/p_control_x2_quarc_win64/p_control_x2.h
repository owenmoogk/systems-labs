...
#ifndef RTW_HEADER_p_control_x2_h_
#define RTW_HEADER_p_control_x2_h_
#include <float.h>
#include <math.h>
#include <string.h>
#ifndef p_control_x2_COMMON_INCLUDES_
#define p_control_x2_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* p_control_x2_COMMON_INCLUDES_ */

#include "p_control_x2_types.h"
...
#define p_control_x2_rtModel           RT_MODEL_p_control_x2_T
...
#define rtB                            p_control_x2_B
#define BlockIO                        B_p_control_x2_T
#define rtP                            p_control_x2_P
#define Parameters                     P_p_control_x2_T
#define rtDWork                        p_control_x2_DW
#define D_Work                         DW_p_control_x2_T

/* Parameters (default storage) */
struct P_p_control_x2_T_ {
  ...
  real_T LookUpTable1_bp01Data[2001];  /* Expression: rep_seq_t - min(rep_seq_t)
                                        * Referenced by: '<S2>/Look-Up Table1'
                                        */
  real_T Kp_Gain;                      /* Expression: 0.22
...
extern P_p_control_x2_T p_control_x2_P;

/* Block signals (default storage) */
extern B_p_control_x2_T p_control_x2_B;

/* Block states (default storage) */
extern DW_p_control_x2_T p_control_x2_DW;

/* Model entry point functions */
extern void p_control_x2_initialize(void);
extern void p_control_x2_output(void);
extern void p_control_x2_update(void);
extern void p_control_x2_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern p_control_x2_rtModel *p_control_x2(void);
...
extern RT_MODEL_p_control_x2_T *const p_control_x2_M;
 ...
 *
 * '<Root>' : 'p_control_x2'
 * '<S1>'   : 'p_control_x2/Plant'
 * '<S2>'   : 'p_control_x2/Repeating Sequence'
 */
#endif                                 /* RTW_HEADER_p_control_x2_h_ */
