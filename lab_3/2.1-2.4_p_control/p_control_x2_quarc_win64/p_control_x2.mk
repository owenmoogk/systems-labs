###########################################################################
## Makefile generated for component 'p_control_x2'. 
## 
## Makefile     : p_control_x2.mk
## Generated on : Mon Nov 10 09:48:42 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\p_control_x2.rt-win64
...
COMPILER_COMMAND_FILE     = p_control_x2_comp.rsp
CMD_FILE                  = p_control_x2.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\p_control_x2.rt-win64
...
DEFINES_STANDARD = -DMODEL=p_control_x2 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\p_control_x2_quarc_win64\p_control_x2.c $(START_DIR)\p_control_x2_quarc_win64\p_control_x2_data.c $(START_DIR)\p_control_x2_quarc_win64\p_control_x2_main.c $(START_DIR)\p_control_x2_quarc_win64\rtGetInf.c $(START_DIR)\p_control_x2_quarc_win64\rtGetNaN.c $(START_DIR)\p_control_x2_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = p_control_x2.obj p_control_x2_data.obj p_control_x2_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\p_control_x2_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\p_control_x2_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
p_control_x2.obj : $(START_DIR)\p_control_x2_quarc_win64\p_control_x2.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p_control_x2_quarc_win64\p_control_x2.c


p_control_x2_data.obj : $(START_DIR)\p_control_x2_quarc_win64\p_control_x2_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p_control_x2_quarc_win64\p_control_x2_data.c


p_control_x2_main.obj : $(START_DIR)\p_control_x2_quarc_win64\p_control_x2_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p_control_x2_quarc_win64\p_control_x2_main.c


rtGetInf.obj : $(START_DIR)\p_control_x2_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p_control_x2_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\p_control_x2_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p_control_x2_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\p_control_x2_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\p_control_x2_quarc_win64\rt_nonfinite.c
