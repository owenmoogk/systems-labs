###########################################################################
## Makefile generated for component 'open_loop_step'. 
## 
## Makefile     : open_loop_step.mk
## Generated on : Mon Nov 10 10:47:50 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\open_loop_step.rt-win64
...
COMPILER_COMMAND_FILE     = open_loop_step_comp.rsp
CMD_FILE                  = open_loop_step.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\open_loop_step.rt-win64
...
DEFINES_STANDARD = -DMODEL=open_loop_step -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\open_loop_step_quarc_win64\open_loop_step.c $(START_DIR)\open_loop_step_quarc_win64\open_loop_step_data.c $(START_DIR)\open_loop_step_quarc_win64\open_loop_step_main.c $(START_DIR)\open_loop_step_quarc_win64\rtGetInf.c $(START_DIR)\open_loop_step_quarc_win64\rtGetNaN.c $(START_DIR)\open_loop_step_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = open_loop_step.obj open_loop_step_data.obj open_loop_step_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\open_loop_step_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\open_loop_step_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
open_loop_step.obj : $(START_DIR)\open_loop_step_quarc_win64\open_loop_step.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\open_loop_step_quarc_win64\open_loop_step.c


open_loop_step_data.obj : $(START_DIR)\open_loop_step_quarc_win64\open_loop_step_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\open_loop_step_quarc_win64\open_loop_step_data.c


open_loop_step_main.obj : $(START_DIR)\open_loop_step_quarc_win64\open_loop_step_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\open_loop_step_quarc_win64\open_loop_step_main.c


rtGetInf.obj : $(START_DIR)\open_loop_step_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\open_loop_step_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\open_loop_step_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\open_loop_step_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\open_loop_step_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\open_loop_step_quarc_win64\rt_nonfinite.c
