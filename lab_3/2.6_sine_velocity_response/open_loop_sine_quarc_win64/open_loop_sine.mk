###########################################################################
## Makefile generated for component 'open_loop_sine'. 
## 
## Makefile     : open_loop_sine.mk
## Generated on : Fri Nov 14 10:10:24 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\open_loop_sine.rt-win64
...
PRODUCT_NAME              = open_loop_sine
MAKEFILE                  = open_loop_sine.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2021b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2021b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\MTE360\Desktop\LAB3GR~1\MTE360~1\MTE360~1\MTE360~1\LAB3_M~1\2506B~1.6_S
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = open_loop_sine_comp.rsp
CMD_FILE                  = open_loop_sine.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\open_loop_sine.rt-win64
...
DEFINES_STANDARD = -DMODEL=open_loop_sine -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\open_loop_sine_quarc_win64\open_loop_sine.c $(START_DIR)\open_loop_sine_quarc_win64\open_loop_sine_data.c $(START_DIR)\open_loop_sine_quarc_win64\open_loop_sine_main.c $(START_DIR)\open_loop_sine_quarc_win64\rtGetInf.c $(START_DIR)\open_loop_sine_quarc_win64\rtGetNaN.c $(START_DIR)\open_loop_sine_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = open_loop_sine.obj open_loop_sine_data.obj open_loop_sine_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\open_loop_sine_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\open_loop_sine_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
open_loop_sine.obj : $(START_DIR)\open_loop_sine_quarc_win64\open_loop_sine.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\open_loop_sine_quarc_win64\open_loop_sine.c


open_loop_sine_data.obj : $(START_DIR)\open_loop_sine_quarc_win64\open_loop_sine_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\open_loop_sine_quarc_win64\open_loop_sine_data.c


open_loop_sine_main.obj : $(START_DIR)\open_loop_sine_quarc_win64\open_loop_sine_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\open_loop_sine_quarc_win64\open_loop_sine_main.c


rtGetInf.obj : $(START_DIR)\open_loop_sine_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\open_loop_sine_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\open_loop_sine_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\open_loop_sine_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\open_loop_sine_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\open_loop_sine_quarc_win64\rt_nonfinite.c
