...
void flexibleDrive_NotchLead_output(void)
{
  ...
  /* Sum: '<Root>/Sum' */
  flexibleDrive_NotchLead_B.Sum = flexibleDrive_NotchLead_B.Output -
    flexibleDrive_NotchLead_B.InverseModulus1;

  /* Gain: '<Root>/Gain' */
  flexibleDrive_NotchLead_B.Gain = flexibleDrive_NotchLead_P.Gain_Gain *
    flexibleDrive_NotchLead_B.Sum;
...
RT_MODEL_flexibleDrive_NotchL_T *flexibleDrive_NotchLead(void)
{
  ...
  /* External mode info */
  flexibleDrive_NotchLead_M->Sizes.checksums[0] = (2282308764U);
  flexibleDrive_NotchLead_M->Sizes.checksums[1] = (1916561509U);
  flexibleDrive_NotchLead_M->Sizes.checksums[2] = (2446868351U);
  flexibleDrive_NotchLead_M->Sizes.checksums[3] = (423981723U);
  ...
  flexibleDrive_NotchLead_M->Sizes.numBlocks = (26);/* Number of blocks */
  flexibleDrive_NotchLead_M->Sizes.numBlockIO = (11);/* Number of block outputs */
